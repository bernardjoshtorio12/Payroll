      ...
      <nav class="nav">
        <div>
          ...
          <div class="nav_list">
            ...
            <a href="view.php" class="nav_link active">
    ...
    <div class="modal fade" id="viewData" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewDataLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="deleteDataModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteDataModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-3" id="deleteDataModalLabel">Warning</h1>
      ...
      <div class="main">
        <div class="container-fluid">
          <div class="mb-3">
            ...
            <p class="fw-bold fs-4 my-3" style="text-align: center;">Employee Records: </p>
            <div class="row">
              <div class="col-12">
                  ...
                  <tr>
                    ...
                    <td class="user_id"><?= $row['Id']?> </td>
                       <td><?= $row['Fname'] . " " . $row['Mname'] ." " .  $row['Lname']?> </td>
                        ...
                        <td><?= $row['Role']?> </td>
                        <td>
                       <button class="btn btn-success btn-sm view-butt"><i class="bx bxs-show bx-tada-hover"></i> View</button>
                       <button type="button" class="btn btn-info btn-sm edit-butt"><i class="bx bxs-edit bx-tada-hover"></i> Edit</button>
                       <button class="btn btn-danger btn-sm delete-butt"><i class="bx bxs-trash-alt bx-tada-hover"></i> Delete</button>
                        </td>
                        </tr>
                         <?php
                            }
